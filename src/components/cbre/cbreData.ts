...
export const RESOLVED_ENTITIES: ResolvedEntity[] = [
  ...
  {
    key: 'vendor',
    rawName: 'Apex HVAC Solutions',
    canonicalName: 'Apex Building Services Group',
...
export const ACTION_ITEMS: ActionItem[] = [
  ...
  },
  {
    ...
    description: 'Apex Building Services Group submitted bid of $87,400 for rooftop unit replacement. Exceeds $25,000 per-item threshold. Owner approval required before proceeding.',
